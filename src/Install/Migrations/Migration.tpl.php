...
final class <?= $className ?> extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eav_type_property_relation_restriction (id UUID NOT NULL, type_property_relation_id UUID NOT NULL, restriction_type_code VARCHAR(255) NOT NULL, restriction JSONB DEFAULT NULL, meta JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE eav_type_property_relation ADD CONSTRAINT FK_eav_type_property_relation_from FOREIGN KEY (from_id) REFERENCES eav_type (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE eav_type_property_relation ADD CONSTRAINT FK_eav_type_property_relation_to FOREIGN KEY (to_id) REFERENCES eav_type (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');

        $this->addSql('ALTER TABLE eav_type_property_relation_restriction ADD CONSTRAINT FK_eav_rtr_type_property_relation_type_id FOREIGN KEY (type_property_relation_id) REFERENCES eav_type_property_relation_type (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE eav_type_property_relation_restriction DROP CONSTRAINT FK_eav_rtr_type_property_relation_type_id');
        ...
        $this->addSql('DROP TABLE eav_type_property_relation_restriction');
